...
public class ShowAirplane extends Fragment {
    ...
    public static ShowAirplane newInstance() {
        return new ShowAirplane();
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_show_airplane, container, false);
    ...
    private void setData(List<HashMap<String, Object>> localList) {
        String[] from = new String[] {"plate","owner", "model", "hoursOnFlight"};
        int[] to = new int[]{ R.id.plate,R.id.owner,R.id.model,R.id.hoursOnFlight};

        // fill in the grid_item layout
        SimpleAdapter localSimpleAdapter = new SimpleAdapter(getActivity().getBaseContext(), localList, R.layout.list_airplane, from, to);
    ...
    class asyncData extends AsyncTask<String, String, List<HashMap<String, Object>>> {
        ...
        protected void onPreExecute() {
            ...
            pDialog.setMessage("Getting Airplanes");
        ...
        protected List<HashMap<String, Object>> doInBackground(String... params) {
            String URL_connect = "http://" + IP_Server + "airplanes?apikey="+APIKEY;
            try {
                return listHandler.createList(post.getInfoJSON(URL_connect),"Airplanes");
            } catch (IOException e) {
